...
const { goldenSignalsMiddleware } = createGoldenSignals('api-gateway');
...
app.post('/orders', async (req, res) => {
  ...
  logger.info('Request autenticado, roteando para order-service', { userId, productId, quantity, step: 'routing' });
